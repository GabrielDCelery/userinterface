managerInterface.controller('mailingCtrl', function($scope, $http, $window, login, language, getCompanyNames, getMailingAddresses, mailFunctions, menuButtons, receit){
